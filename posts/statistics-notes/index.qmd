...
It is a statistical measure that describes the degree to which two variables change together. 
Correlation coefficient such as Pearson's correlation coefficient ranges from -1 to 1.
1  => Perfect positive correlation. This implies that if one variable increases then the other variable also increases proportionally.
-1 => Perfect negative correlation. This implies that if one variable increases then the other variable also decreases proportionally.
