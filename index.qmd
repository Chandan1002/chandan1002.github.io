...
I am currently attending Iowa State University for my Ph.D. I attended Iowa State University for my masters studies, graduating with a distinction (1st class). 
...
As part of my service to the profession, I've been a reviewer for [ICLR](https://joss.theoj.org/papers/reviewed_by/@chrisvoncsefalvay) and [NeurIPS](https://loop.frontiersin.org/people/1398311/editorial) . 
...
-   **Deep Learning**: Unsupervised Learning algorithm, Unsupervised object retrieval.
...
In my free time, I enjoy reading , cooking (with not a lot of success). 
